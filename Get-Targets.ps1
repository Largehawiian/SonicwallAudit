function Get-Targets {
    ...
    switch ($query) {
        ...
        "TFA"   {Invoke-Sqlcmd -ServerInstance $instance -Database $DBName -Credential $creds -Query "select * From accounts where MFAEnabled='Y' AND Active='Y' AND Gen7='N' AND TFA IS NOT NULL"}
        "GeoIP" {
